...
<p><b>Nombre del Motociclista:</b>&nbsp; {{ $pagos->name }} {{ $pagos->ap }} {{ $pagos->am }}</p>
<p><b>Modo de Pago:</b>&nbsp;{{ $pagos->modopago }}</p>
<p><b>Producto:</b>&nbsp;{{ $pagos->producto }}</p>
<p><b>Cantidad:</b>&nbsp;{{ $pagos->cantidad }}</p>
<p><b>Precio:</b>&nbsp;{{ $pagos->precio }}</p>
